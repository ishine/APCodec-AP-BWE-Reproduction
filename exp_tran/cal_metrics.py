...
def main(h):
    ...
    predicted_label_dir = "/mnt/nvme_share/srt30/checkpoint/exp_tasr/output_label_182k/predicted_labels.json"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--synthesis_wav_dir', default='/mnt/nvme_share/srt30/checkpoint/exp_tasr/output_wav_182k')
