...
def main(h):
    ...
    for wav_index in track(wav_indexes):
        ...
        if not os.path.exists(syn_path):
            print(f"警告：在 {h.synthesis_wav_dir} 中未找到 {wav_index}，跳过此文件。")
            continue
...
if __name__ == '__main__':
    ...
    parser.add_argument('--reference_wav_dir', default='/mnt/nvme_share/srt30/Datasets/VCTK-0.92/wav8/origin/test')
    parser.add_argument('--synthesis_wav_dir', default='/mnt/nvme_share/srt30/checkpoint/exp_gem3/output_wav_80000')
