...
from exp_vb.utils import init_weights, get_padding
import numpy as np
from exp_vb.quantize import ResidualFSQ
...
class Encoder(torch.nn.Module):
    ...
    def forward(self, logamp, pha, n_quantizers=None):
        ...
        latent,codes,_,commitment_loss,codebook_loss = self.quantizer(latent,n_quantizers=n_quantizers)
