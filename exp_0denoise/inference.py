...
import json
import torch
from exp_0denoise.utils import AttrDict
from exp_0denoise.dataset import amp_pha_specturm, load_wav
from exp_0denoise.models import Encoder, Decoder
...
def inference(h):
    ...
    with torch.no_grad():
        for i, filename in enumerate(filelist):
            ...
            latent,_,_,_ = encoder(logamp, pha)
