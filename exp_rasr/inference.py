...
import json
import torch
from exp_rasr.utils import AttrDict
from exp_rasr.dataset import amp_pha_specturm
from exp_rasr.models import Encoder, Decoder
...
def greedy_decode_rnn(encoder, memory, vocab, max_len=50, bos_idx=1, eos_idx=2):
...
def inference(h):
    ...
    with torch.no_grad():
        for filename in filelist:
            ...
            memory = encoder.asr_proj_linear(lbq.permute(2, 0, 1))  # [T_frame, 1, 512]
            indices, pred_text = greedy_decode_rnn(encoder, memory, vocab)
