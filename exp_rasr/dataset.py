...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, training_files, segment_size, n_fft, num_mels_for_loss,
        ...
        if self.split:
            self.audio_files = [f for f in self.audio_files if os.path.splitext(os.path.basename(f))[0] in self.label_dict]
    ...
    def __getitem__(self, index):
        ...
        return (audio.squeeze(),text_label, target_length, input_length, basename)
